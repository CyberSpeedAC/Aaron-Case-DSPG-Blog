...
During week two I learned how to get data from the American Community Survey (ASC). Turning this data into both a bar plot, and chorpleth map using Tidycensus in R.
...
md_plot_ggiraph <- girafe(ggobj = md_plot_ggiraph) %>% girafe_options(opts_hover(css = "fill:purple;"))
