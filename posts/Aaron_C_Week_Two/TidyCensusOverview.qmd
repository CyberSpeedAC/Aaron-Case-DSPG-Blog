...
During week two I learned how to get data from the American Community Survey (ASC) an turn it into both a bar plot and chorpleth map using Tidycensus in R.
